    ...
    >
      ...
      <div className="flex items-center justify-between mb-12">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-black tracking-tighter uppercase">Moodrae</span>
        </div>
      ...
      <div className="mt-12 pt-8 border-t border-zinc-500/10 flex items-end justify-between">
        <div>
          ...
          <p className="text-xs font-black text-zinc-400/60 uppercase tracking-tighter">MOODRAE.IO</p>
        </div>
